...
<head>
    ...
    <style>
        ...
        .promocion-titulo { font-size: 1.5rem; font-weight: 700; margin-bottom: 0.5rem; position: relative; z-index: 1; }
        .promocion-badge { background: rgba(255, 255, 255, 0.2); color: white; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.8rem; font-weight: 600; display: inline-block; margin-bottom: 1rem; }
        .promocion-imagen { height: 200px; object-fit: cover; }
        .back-button { color: #6c757d; text-decoration: none; font-weight: 600; transition: color 0.3s ease; }
        .back-button:hover { color: #ff6b6b; }
        .no-promociones { text-align: center; padding: 4rem 2rem; color: #6c757d; }
        .no-promociones .icon { font-size: 4rem; margin-bottom: 1rem; opacity: 0.5; }
    </style>
</head>
